...
<head>
  ...
  <!-- Product Search CSS -->
  <link rel="stylesheet" href="assets/css/product-search.css">
  <!-- Customer Dropdown Fix CSS -->
  <link rel="stylesheet" href="assets/css/customer-dropdown-fix.css">
  <!-- Product Image Select2 CSS -->
  <link rel="stylesheet" href="assets/css/select2-custom.css">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <div class="notice">
          <li>
            <i class="material-symbols-outlined">
              <a href="#" target="_blank"> notifications</a></i>
          </li>
          <li> <i class="material-symbols-outlined"><a href="#" target="_blank"> mail</a></i></li>
          <li>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">
            <img src="assets/images/user.jpg" class="rounded-lg">
