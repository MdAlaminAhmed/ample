                ...
                <div class="modal-dialog modal-xl">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="alert alert-primary alert-dismissible fade show memberFormError" style="display:none;" role="alert">
                        <span id="suppliarFormError"></span>
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        ...
                        <div class="col-md-12 col-lg-12">
                          ...
                          <button type="submit" class="btn btn-primary btn-block rounded-0">Add Supplier</button>
                        </form>
                      </div>
                      <!-- Modal footer -->
