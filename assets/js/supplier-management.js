$(document).ready(function() {
    // Wait for DataTables to initialize first in custom.js
    // Reference the existing DataTable
    var table = $('#suppliarTable').DataTable();
    
    // Debug table state
    console.log("Supplier table initialization complete");
