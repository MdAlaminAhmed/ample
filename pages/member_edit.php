          ...
          if (isset($_GET['edit_id'])) {
           ...
           $data = $obj->find('member' , 'id' , $edit_id);
            ...
            <form id="editMemberForm">
              ...
              <div class="form-group">
                <label for="company">Customer Type *:</label>
                <select class="form-control add-member" id="company" name="company">
                  <option value="Regular" <?php echo ($data->company == 'Regular') ? 'selected' : ''; ?>>Regular</option>
                  <option value="Walk-in" <?php echo ($data->company == 'Walk-in') ? 'selected' : ''; ?>>Walk-in</option>
                </select>
              </div>
              <div class="form-group">
