          ...
          <div class="card">
            <div class="card-body">
              ...
              if (isset($_GET['edit_id'])) {
                ...
                if ($data) {
              ?>
                  <form id="editProduct" enctype="multipart/form-data" method="post" action="app/action/edit_product.php">
                    <div class="row">
                      ...
                      <div class="col-md-4 col-lg-4">
                        <div class="form-group">
                          ...
                          <?php if (!empty($data->product_image)): ?>
                            <div class="mb-2">
                              <img src="<?= $data->product_image; ?>" alt="<?= $data->product_name; ?>" class="img-thumbnail" style="max-height: 150px;">
                            </div>
                          <?php endif; ?>
                          ...
                          <input type="hidden" name="existing_image" value="<?= $data->product_image; ?>">
                        </div>
                      </div>
                    </div>
