...
foreach ($empRecords as $row) {
   ...
   $product_name_with_image = '<div style="display:flex;align-items:center;"><img src="' . $product_img . '" style="width:40px;height:40px;margin-right:10px;object-fit:contain;border-radius:4px;border:1px solid #ddd;" /><span>' . $row['product_name'] . '</span></div>';

   $data[] = array(
      "product_id" => $row['product_id'],
      "product_name" => $product_name_with_image,
